...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/18 04:36:14 by hyeykim           #+#    #+#             */
/*   Updated: 2020/10/18 04:36:19 by hyeykim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// Practice: Draws a rectangle with ASCII characters for rush04.
...
void	test(int x, int y, int x1, int y1)
{
	...
	else if ((x1 == 0 && y1 == y - 1) || (x1 == x - 1 && y1 == 0))
	{
		ft_putchar('C');
	}
